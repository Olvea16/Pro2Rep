...
.CSEG		    ;Angiver at dette tilhører programhukommelse. Markerer starten på et kodesegment med sin egen location counter.  
.ORG 0			;Vektoradresse for Reset.
RJMP Setup      ;Springer til setup. 
.ORG ADCCaddr	;Dette er den for en ADC er færdig 
RJMP ADCDone
.ORG 30			;Sætter adressen for denne linje til 30, da dette ville være lige efter 28+2.
...
CmdCheck:
	...
	CALL IsCom		;Hvis InCmd derimod er tom, tjekker programmet om den modtagne besked i InBesked er en kommmando med subroutinen IsCom.
