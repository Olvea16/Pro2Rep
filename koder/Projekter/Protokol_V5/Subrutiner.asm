...
.EQU CmdIn_AccRefP_LED_Send = 32
.EQU CmdIn_AccRefN_LED_Send = 40
...
SendAccRef:
	...
	MOV Arg, AccRefP
	CALL Send
	LDI Arg, CmdIn_AccRefP_LED_Send
	CALL LED1SekSet
	RET
	...
	MOV Arg, AccRefN
	CALL Send
	LDI Arg, CmdIn_AccRefN_LED_Send
	CALL LED1SekSet
	RET
